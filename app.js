...
function mostrarToast(mensaje, tipo = 'success') {
  //Obtencion del elemento del doom
  let toast = document.getElementById('app-toast');
  //Si no existe crea una nueva capa, le añade como id app-toast y lo añade 
  if (!toast) {
    toast = document.createElement('div');
    toast.id = 'app-toast';
    document.body.appendChild(toast);
  }
  //Añade el mensaje al div creado o el que esta ya dentro del documento 
